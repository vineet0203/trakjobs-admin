            ...
            >
              <Paper
                sx={{
                  ...
                  "&:hover": { boxShadow: "0 8px 24px -12px rgba(124,58,237,.18)" },
                }}
              >
                <div
                  className="flex items-center justify-center rounded-full shrink-0"
                  style={{ background: s.iconBg, width: 56, height: 56 }}
                >
                  <s.Icon size={26} color={s.iconColor} />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-sm text-[#6B7280] font-medium">{s.label}</div>
                  <div className="text-3xl font-extrabold text-[#111827] leading-tight mt-0.5">
                    {s.value}
                  </div>
                  <div
